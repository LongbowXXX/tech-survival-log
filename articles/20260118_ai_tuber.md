---
title: "React/TS 未経験の元組込み屋が、Google ADK で自律型 AI V-Tuber を作ってみた話"
emoji: "🛡️"
type: "tech"
topics: ["python", "googleadk", "mcp", "react", "survival"]
published: false
---
...
Google が出している [ADK](https://github.com/google/labs-agent-development-kit) は、複数のエージェント（人格や役割）を協調させるフレームワークです。
